...
<body>
    ...
    <div class="container">
        <h1>Exercice 2</h1><br><br>
        <form method="post" action="">
            <label for="nombre">Entrez un nombre :</label>
            <input type="texte" id="nombre" name="nombre" required><br><br>
        ...
        <div class="nav-buttons">
            <a href="exercice1.php">Précédent</a>
            <a href="exercice3a.php">Suivant</a>   
        </div>
    </div>
</body>
</html>